...
|<img src="nn.jpg" alt="drawing" width="400"/>| Nikolay Nikitin (nnikitin@itmo.ru) &nbsp| Intelligent optimization algorithms, model tuning, generative AutoMl framework development|

|<img src="ah.jpg" alt="drawing" width="400"/>| Alexander Hvatov (alex_hvatov@itmo.ru) &nbsp &nbsp| Evolutionary algorithms for data-driven modeling, differential equations, acoustics, etc.|
